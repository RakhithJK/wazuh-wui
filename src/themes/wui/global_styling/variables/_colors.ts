...
export const light_colors_wui: _EuiThemeColors = {
  // Brand
  primary: '#07C',
  accent: '#F04E98',
  success: '#00BFB3',
...
export const dark_colors_wui: _EuiThemeColors = {
  // Brand
  primary: '#36A2EF',
  accent: '#F68FBE',
  success: '#7DDED8',
...
export const colors_wui: EuiThemeColors = {
  ghost: '#FFF',
  ink: '#000',
  LIGHT: light_colors_wui,
  DARK: dark_colors_wui,
};
